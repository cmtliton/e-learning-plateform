<template>
      <v-btn
        id="activator-SignUp"
        width="90"
        class="rounded-pill text-none text-subtitle-1 mt-2"
      >
        Sign Up
      </v-btn>
  
      <v-dialog activator="#activator-SignUp" max-width="560">
        <template v-slot:default="{ isActive }">
          <v-fade-transition hide-on-leave>
            <v-card class="mx-auto rounded-lg" max-width="560" elevation="10">
              ...
              <v-card-actions class="bg-grey-lighten-3 text-grey-darken-1">
                <v-btn flat rounded class="text-indigo text-none">Sign Up</v-btn>
                <v-spacer></v-spacer>
