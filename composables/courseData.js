    ...
    chapters: [
      {
        ...
        lessons: [
        {
          title: 'Hello, Laravel 11', slug: '0-hello-laravel-11', number: 1, videoId: '1NjOWtQ7S2o', text: 'We should create a layout file to reduce the amount of HTML duplication from the previous episode. This will provide the perfect opportunity to discuss Laravel components.',
        },
        {
          title: 'Your First Route and View', slug: '0-route-and-view', number: 2, videoId: 'KHxGAOv2Emc', text: 'We should create a layout file to reduce the amount of HTML duplication from the previous episode. This will provide the perfect opportunity to discuss Laravel components.',
        },
        {
          title: 'Create a Layout File Using Blade Components', slug: '0-create-layout-file-blade', number: 3, videoId: 'H5R3vV38QiM', text: 'We should create a layout file to reduce the amount of HTML duplication from the previous episode. This will provide the perfect opportunity to discuss Laravel components.',
        }
